...
import {
  ...
  dayProfit,
  monthProfit,
} from "../../service/statistics/statisticsService";
  ...
  useEffect(() => {
    const getMonthRevenues = async () => {
      try {
        ...
        console.log("abc", monthRevenuesData);
        ...
        <div className="container-fluid pt-4 px-5 shadow-lg">
          <div className="row p-0 m-0">
            <div className="col-sm-12 col-lg-12 col-md-12 p-0">
              <legend
                className={`${styles.heading} fw-bolder text-center mb-3`}
              >
                ...
                onSubmit={(value) => {
                  ...
                  const getTotal = async () => {
                    try {
                      ...
                      {
                        monthCostsData.data[0] !== null
                          ? setMonthCosts(monthCostsData.data[0].totalCost)
                          : setMonthCosts(0);
                      }
                      // eslint-disable-next-line no-lone-blocks
                      {
                        monthRevenuesData.data[0] !== null
                          ? setMonthRevenues(
                              monthRevenuesData.data[0].totalRevenue
                            )
                          : setMonthRevenues(0);
                      }
                      // eslint-disable-next-line no-lone-blocks
                ...
                <Form className="container-fluid p-0 ">
                    ...
                    >
                      ...
                      {statistics.length !== 0 ? (
                        <span>
                          {" "}
                          {getMonth} :{" "}
                          {monthRevenues.toLocaleString("vi-VN", {
                            style: "currency",
                            currency: "VND",
                          })}
                        </span>
                      ) : (
                        <span> {getMonth} : 0 đ</span>
                      )}
                    </h6>
                  </div>
                    ...
                    >
                      ...
                      {monthCosts.length !== 0 ? (
                        <span>
                          {" "}
                          {getMonth} :{" "}
                          {monthCosts.toLocaleString("vi-VN", {
                            style: "currency",
                            currency: "VND",
                          })}
                        </span>
                  ...
                  <div className="d-flex justify-content-center mt-2 mb-4">
                    ...
                    >
                      ...
                      {(monthRevenues - monthCosts).toLocaleString("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      })}{" "}
                    </h6>
